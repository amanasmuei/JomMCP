    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                print(f"   ✅ Login successful! Got access token: {data['access_token'][:20]}...")
    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   Allowed methods: {cors_headers.get('access-control-allow-methods', 'None')}")
                print(f"   Allowed headers: {cors_headers.get('access-control-allow-headers', 'None')}")
            else:
