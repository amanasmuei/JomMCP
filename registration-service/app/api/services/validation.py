...
class APIValidationService:
    ...
    async def validate_api(self, request: APIValidationRequest) -> APIValidationResponse:
        """
        ...
        try:
            ...
            if request.authentication_type != AuthenticationType.NONE and request.credentials:
                headers.update(self._get_auth_headers(request.authentication_type, request.credentials))
    ...
    def _get_auth_headers(self, auth_type: AuthenticationType, credentials: Dict[str, str]) -> Dict[str, str]:
        """
            ...
            try:
                ...
                if response.status_code == 200:
                    try:
                        ...
                        specification = spec
                        break
                    except (json.JSONDecodeError, OpenAPIValidationError):
                        continue
            except Exception:
                continue
