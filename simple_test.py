...
if response.status_code == 200:
    ...
    response = requests.get("http://localhost:8000/api/v1/registrations", headers=headers)
    ...
    response = requests.post("http://localhost:8000/api/v1/registrations", json=api_data, headers=headers)
