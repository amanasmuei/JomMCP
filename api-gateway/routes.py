...
@api_router.api_route("/auth/{path:path}", methods=["GET", "POST", "PUT", "DELETE", "PATCH"])
...
@api_router.api_route("/users/{path:path}", methods=["GET", "POST", "PUT", "DELETE", "PATCH"])
...
@api_router.api_route("/registrations/{path:path}", methods=["GET", "POST", "PUT", "DELETE", "PATCH"])
...
@api_router.api_route("/generation/{path:path}", methods=["GET", "POST", "PUT", "DELETE", "PATCH"])
...
@api_router.api_route("/deployments/{path:path}", methods=["GET", "POST", "PUT", "DELETE", "PATCH"])
...
@api_router.api_route("/docs/{path:path}", methods=["GET", "POST", "PUT", "DELETE", "PATCH"])
